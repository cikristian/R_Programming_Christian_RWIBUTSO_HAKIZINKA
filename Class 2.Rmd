...
Test to treat data
```{r}
data1 <- read.table("C:/Users/pc/Desktop/REXAM/Assignment/dataset1.csv", header = TRUE)
...
barplot(as.matrix(data2),main="Confirmed cases Vs Age categories",
        beside=TRUE,col=c("green","blue","purple"))
barplot(as.matrix(data2),main="Confirmed cases Vs Age categories",
        beside=TRUE,col=c("green","blue","purple"))
legend("topleft", c("Less than 15 years","15-49 years","Above 50"),
       cex= 1.3,bty="n",fill = c("green","blue","purple"))

```
```{r}
months <- c("Sept_2022","Oct_2022","Nov_2022","Dec_2022","Jan_2023",
...
# Base plot
plot(Confirmed_covid, type="o", pch=21, col="red", ylim=c(0,350),
     xaxt="n", ylab="Number of patients", main="Confirmed cases Vs Treatment")

# Add treatment line
lines(treatment, type="o", col="blue", lty=2, pch=22)

# Custom x-axis
axis(1, at=1:10, labels=months, las=2, cex.axis=0.8)

# Legend for lines
legend("topleft", legend=c("Received treatment", "Confirmed"),
       col=c("blue","red"), lty=c(2,1), pch=c(22,21), cex=0.8, bty="n")
...
plot(number_of_test, type="o", col="blue", ylim=c(0,24000),
     xaxt="n", ylab="Number of Tests", main="COVID-19 Tests")
...
ggplot(data=mtcars, aes(x=wt,y=mpg))+geom_point(pch=17,color="blue",
                                                sie=1)+ geom_smooth(method="lm",color="green")+
labs(title = "Automobile Data",x="Weight",y="Miles per Galon")
```
```{r}
...
```{r}
data_class<- read.table("C:/Users/pc/Desktop/REXAM/Assignment/dataset1.csv", header = TRUE)
